...
(() => {
  ...
  // src/index.ts
  // React/ReactDOM are vendored locally (src/vendor/) so the app boots with no
  // network round-trip — a CDN fetch here previously blocked all rendering on
  // every page load. Local files need no SRI/crossOrigin.
